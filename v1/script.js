...
async function loadFacts() {
  const res = await fetch(
    "https://tiriekihoeqhymszyibq.supabase.co/rest/v1/facts",
    {
      headers: {
        apikey:
        ...
        authorization:
          "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InRpcmlla2lob2VxaHltc3p5aWJxIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzAyMzIzODgsImV4cCI6MjA4NTgwODM4OH0.YvPiGP7A_1MY0aGafcA_LRmcpE4sMhOacPJG1EqU72M",
      },
    },
  );
